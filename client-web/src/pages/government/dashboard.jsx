...
const contractsMock = [
  ...
  },
  {
    ...
    status: "Completed",
    milestones: [
      { description: "Initial survey", amount: 80000, verified: true },
    ],
  },
  {
    id: 3,
    ...
    <PageLayout>
      <div className="p-6">
        ...
        <div className="grid grid-cols-4 gap-4 mb-8">
          <Card className="shadow-md bg-white" title="Total Contracts">
            <p className="text-2xl font-bold">{totalContracts}</p>
          </Card>
          <Card className="shadow-md bg-white" title="Total Subsidy Allocated">
            <p className="text-2xl font-bold">
              ₹{totalSubsidy.toLocaleString()}
            </p>
          </Card>
          <Card className="shadow-md bg-white" title="Producers Involved">
            <p className="text-2xl font-bold">{producersCount}</p>
          </Card>
          <Card className="shadow-md bg-white" title="Pending Contracts">
        ...
        <div className="grid grid-cols-2 gap-6 mb-8">
          ...
          <Card
            ...
            title="Milestone Completion Over Time"
          >
          ...
          <Card
            className="shadow-md bg-white"
            title="Subsidy Utilization Trend"
          >
            <ResponsiveContainer width="100%" height={300}>
              <LineChart
                data={subsidyData}
